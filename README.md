...
> **My contribution:** Frontend development. I worked on the user interface, Razor Views, HTML/CSS/JavaScript, Bootstrap components, dynamic UI interactions, and frontend-to-backend communication.

The project was developed as a relatively large-scale academic/software-engineering project, combining backend architecture, database design, authentication, tournament business logic, and interactive frontend components.
...
My primary role in this project was **Frontend Development**.

I worked on the presentation and interaction layer of the application, including:

- Designing and implementing web pages and user interfaces
- Developing Razor Views
- Writing and organizing HTML and CSS
- Implementing JavaScript-based interactions
- Using Bootstrap components and responsive layouts
- Creating dynamic UI components for tournament management
- Displaying tournament, participant, match, and bracket information
- Connecting frontend interactions to backend endpoints through HTTP/API requests
- Implementing client-side behavior for an interactive user experience
- Integrating frontend components with the ASP.NET Core MVC structure

The frontend communicates with backend endpoints to display and update tournament-related information, including interactive sections that can update without a full page reload.
...
The bracket is generated based on tournament participants and match results. When a match is completed, the winner can progress to the appropriate next stage.
...
The result of one match can affect the participants of another match in the next round. This creates a dependency chain between matches and requires the application to maintain tournament state consistently.
...
- Email-related account workflows
...
**My primary contribution to the project was this frontend layer.**
...
Sensitive configuration values such as connection strings, email credentials, and authentication secrets should be stored outside source control in production environments.
...
| REST-style APIs | Client/server communication |
...
One of the main challenges of Tournament Table was managing the relationship between the application's data model and tournament state.
...
The main challenge of Tournament Table was not simply creating forms and storing records in a database.
...
Computer Engineering — Persian Gulf University

📍 Shiraz, Iran

- GitHub: https://github.com/NazaninNiazi
- LinkedIn: https://www.linkedin.com/in/nazanin-niazi

### Contribution

**Frontend Developer / Frontend Project Contributor**

My contribution focused on the frontend development of the application, including UI implementation, Razor Views, HTML/CSS, JavaScript, Bootstrap, dynamic interface components, and frontend-to-backend communication.

---

## 📄 Note

This repository documents my contribution and the overall architecture and features of the **Tournament Table** academic project. The project was developed collaboratively, and the backend, database, and authentication components were not solely implemented by me.
